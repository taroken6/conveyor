...
var getHeaders = function getHeaders(schema, modelName, node) {
  ...
  var headers = Object.entries(node).map(function (_ref) {
...
var getRowFields = function getRowFields(schema, modelName, node) {
  var fieldDefinitions = (0, _schemaGetters.getFields)(schema, modelName);
  var fields = Object.entries(node).map(function (_ref3) {
...
var Row = function Row(_ref5) {
  var schema = _ref5.schema,
      nodeModelName = _ref5.nodeModelName,
      node = _ref5.node;
  var fields = getRowFields(schema, nodeModelName, node);
...
var HeaderRow = function HeaderRow(_ref6) {
...
var ReviewTable = function ReviewTable(_ref7) {
  ...
  if (!R.isEmpty(table)) {
    var node = table[0];
    var nodeModelName = R.prop('__typename', node);
    headers = getHeaders(schema, nodeModelName, node).map(function (fieldName) {
      return R.path([nodeModelName, 'fields', fieldName, 'displayName'], schema);
    });
  }
  ...
  return _react["default"].createElement("div", {
    ...
    className: "d-inline"
  }, table[0].__typename), _react["default"].createElement("table", {
...
var DeleteDetail = function DeleteDetail(_ref8) {
  var schema = _ref8.schema,
      modelName = _ref8.modelName,
      id = _ref8.id,
      modalId = _ref8.modalId,
      title = _ref8.title,
      onDelete = _ref8.onDelete,
      modalStore = _ref8.modalStore,
