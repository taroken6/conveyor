...
exports.isDetailFieldFooterShown = exports.isDetailTableFooterShown = exports.isFooterShown = exports.isIndexTableFooterShown = exports.isTableSortable = exports.isSortable = exports.isFieldDisabled = exports.shouldDisplay = exports.isCreatable = exports.isDeletable = exports.isTableDeletable = exports.isFieldEditable = exports.isRowEditable = exports.isTableEditable = exports.getEnumLabel = exports.skipOverride = exports.getIndexPageOverride = exports.getIndexTitleOverride = exports.getIndexOverride = exports.getDetailPageOverride = exports.getDetailTitleOverride = exports.getDetailOverride = exports.getCreatePageOverride = exports.getCreateTitleOverride = exports.getCreateOverride = exports.getInputOverride = exports.getDetailValueOverride = exports.getDetailLabelOverride = exports.getDetailFieldOverride = exports.getCellOverride = exports.titleize = exports.humanize = exports.trimWhitespaceBetweenWords = exports.underscoreToSpace = exports.spaceOnCapitalLetter = exports.capitalizeFirstChar = void 0;
...
var isIndexTableFooterShown = function isIndexTableFooterShown(_ref12) {
  var schema = _ref12.schema,
      modelName = _ref12.modelName,
      user = _ref12.user;
  var footerShown = R.pathOr(false, [modelName, 'showFooter'], schema);
  if (footerShown === false) return false;

  if (R.type(footerShown) === 'Function' && footerShown({
    schema: schema,
    modelName: modelName,
    user: user
  }) === false) {
...
exports.isIndexTableFooterShown = isIndexTableFooterShown;

var isFooterShown = function isFooterShown(_ref13) {
  ...
  return (0, _isType.isCurrency)((0, _schemaGetters.getField)(schema, modelName, fieldName));
};

exports.isFooterShown = isFooterShown;

var isDetailTableFooterShown = function isDetailTableFooterShown(_ref14) {
  var schema = _ref14.schema,
      parentModelName = _ref14.parentModelName,
      modelName = _ref14.modelName,
      user = _ref14.user;
  var footerShown = R.pathOr(false, [parentModelName, 'showFooter'], schema);
  if (!footerShown) return false;
  if (R.type(footerShown) === 'Function' && footerShown({
    schema: schema,
    parentModelName: parentModelName,
    user: user
  }) === false) return false;
  var parentModel = R.prop(parentModelName, schema);
  var parentFieldOrder = R.prop('fieldOrder', parentModel);
  var parentBoolList = R.map(function (parentFieldName) {
    var model = R.prop(parentModelName, schema);
    var fieldOrder = R.prop('fieldOrder', model);
    var boolList = R.map(function (fieldName) {
      return isDetailFieldFooterShown({
        schema: schema,
        parentModelName: parentModelName,
...
exports.isDetailTableFooterShown = isDetailTableFooterShown;

var isDetailFieldFooterShown = function isDetailFieldFooterShown(_ref15) {
  var schema = _ref15.schema,
      parentModelName = _ref15.parentModelName,
      parentFieldName = _ref15.parentFieldName,
  ...
  return (0, _isType.isCurrency)((0, _schemaGetters.getField)(schema, parentModelName, parentFieldName)) || (0, _isType.isCurrency)((0, _schemaGetters.getField)(schema, modelName, fieldName));
};
