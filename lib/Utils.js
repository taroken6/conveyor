...
var isSortable = function isSortable(_ref10) {
  ...
  console.log('fieldSortable', fieldName, fieldSortable);
  console.log('bool?', fieldName, fieldSortable === false);
  console.log('func?', fieldName, R.type(fieldSortable) === 'Function');
