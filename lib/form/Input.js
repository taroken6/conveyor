...
var Input = function Input(_ref4) {
  ...
  var InputOverride = (0, _Utils.getInputOverride)(schema, modelName, fieldName); //console.log('node', node)
  ...
  return _react["default"].createElement(InputCore, {
    schema: schema,
    modelName: modelName,
    fieldName: fieldName,
    node: node,
...
var InputCore = function InputCore(_ref6) {
  ...
  switch (inputType) {
    ...
    case _consts.inputTypes.RELATIONSHIP_MULTIPLE:
      var options = (0, _schemaGetters.getOptionsOverride)({
        schema: schema,
        modelName: modelName,
        fieldName: fieldName,
