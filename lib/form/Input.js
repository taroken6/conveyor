...
var InputCore = function InputCore(_ref5) {
  var schema = _ref5.schema,
      ...
      props = _objectWithoutProperties(_ref5, ["schema", "modelName", "fieldName", "value", "error", "inline", "onChange", "selectOptions", "customLabel", "onMenuOpen", "customProps", "autoFocus"]);
  ...
  console.log('autoFocus IC:', fieldName, autoFocus);
  ...
  var fieldLabel = (0, _Detail.getFieldLabel)({
    schema: schema,
    modelName: modelName,
    fieldName: fieldName,
    data: {}
