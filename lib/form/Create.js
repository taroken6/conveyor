...
var Create = function Create(_ref5) {
  ...
  return _react["default"].createElement("div", {
    ...
    schema: schema,
    formStack: formStack
  }), _react["default"].createElement("h1", null, "Create ", (0, _Detail.getModelLabel)({
    schema: schema,
    modelName: modelName,
    form: form
  })), _react["default"].createElement("div", null, "* Indicates a Required Field"), _react["default"].createElement("br", null), _react["default"].createElement("div", null, fieldOrder.map(function (fieldName, idx) {
