...
var DefaultCreatePage = function DefaultCreatePage(_ref5) {
  ...
  return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("div", null, "* Indicates a Required Field"), _react["default"].createElement("br", null), _react["default"].createElement("div", null, fieldOrder.map(function (fieldName) {
    var displayCondition = R.prop('create', (0, _schemaGetters.getFieldConditions)(schema, modelName, fieldName));
    ...
    var disabled = (0, _Utils.isFieldDisabled)({
      schema: schema,
      modelName: modelName,
      fieldName: fieldName,
      formStack: formStack,
    ...
    if (!autoFocusAdded && (0, _index.isAutoFocusInput)((0, _getType.getType)({
      schema: schema,
      modelName: modelName,
      fieldName: fieldName
    }))) {
