...
var getCreateFieldOrder = function getCreateFieldOrder(schema, modelName) {
  var fields = (0, _schemaGetters.getFields)(schema, modelName);

  var filtered = R.pipe(R.prop('fieldOrder'), R.filter(function (fieldName) {
    return R.path([fieldName, 'showCreate'], fields);
  }))((0, _schemaGetters.getModel)(schema, modelName));
...
var Create = function Create(_ref5) {
  ...
  var fieldOrder = getCreateFieldOrder(schema, modelName);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      null,
      'Create ',
      (0, _Detail.getModelLabel)({ schema: schema, modelName: modelName })
    ),
    _react2.default.createElement(
      'div',
      null,
