...
exports["default"] = exports.TabFields = void 0;
...
var TabFields = function TabFields(_ref) {
  ...
  return _react["default"].createElement(_Detail.DetailFields, _objectSpread({
    schema: schema,
    modelName: modelName,
    id: id,
    node: node,
...
var RecursiveTab = function RecursiveTab(_ref2) {
  ...
  return _react["default"].createElement("div", null, _react["default"].createElement(TabFields, _objectSpread({
    match: match,
    tabs: tabs,
    fields: fields,
    component: component,
