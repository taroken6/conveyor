...
var Pagination = function Pagination(_ref2) {
  ...
  var totalDataLength = R.prop('totalDataLength', tableView);
  var paginationAmt = R.prop('paginationAmt', tableView);
  var lastIndex = Math.floor((totalDataLength - 1) / paginationAmt); // get previous & last conditions

  var hasPrevious = idx > 0;
  var hasLast = lastIndex > 0 && idx !== lastIndex;
  console.log('totalDataLength', totalDataLength);
  console.log('lastIndex', lastIndex);
  console.log('idx', idx);
  console.log('hasPrev', hasPrevious);
  console.log('hasLast', hasLast); // no pagination
  ...
  }, hasPrevious && _react["default"].createElement(PaginationLink, {
    modelName: modelName,
