...
var IndexPagination = function IndexPagination(_ref3) {
  ...
  var lastIndex = R.path(['lastIndexPagination', modelName], tableView);
...
var DetailPagination = function DetailPagination(_ref4) {
  ...
  var idx = R.pathOr(0, ['relTablePage', modelName, fieldName], tableView); // get index of last hypothetical data point

  var lastIndex = R.path(['lastIndexRelTablePagination', modelName, fieldName], tableView);
  return _react["default"].createElement(Pagination, {
    modelName: modelName,
    fieldName: fieldName,
    idx: idx,
