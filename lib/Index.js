...
var DefaultIndexTitle = function DefaultIndexTitle(_ref) {
  ...
  return _react["default"].createElement("div", {
    ...
    className: "d-inline"
  }, R.pathOr('No Name Found', [modelName, 'displayNamePlural'], schema)), creatable && _react["default"].createElement("div", {
...
var Index = function Index(_ref2) {
  ...
  return _react["default"].createElement("div", {
    ...
    modelName: modelName,
    path: path
  }, props)), !R.isEmpty(data) && _react["default"].createElement(Table, _objectSpread({
    schema: schema,
    modelName: modelName,
    data: data,
    onDelete: onDelete,
