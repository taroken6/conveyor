...
exports["default"] = exports.getLastSingleton = exports.DefaultIndexTitle = void 0;
...
var getLastSingleton = function getLastSingleton(store) {
  if (store) {
    return R.prop(R.tail(store.order), store.values);
  }
};

exports.getLastSingleton = getLastSingleton;
...
var Index = function Index(_ref3) {
  ...
  if (R.path([modelName, 'singleTon'], schema)) {
    ...
    return _react["default"].createElement("div", {
      className: "container"
    }, _react["default"].createElement("h1", null, "No Directory Exists", _react["default"].createElement(_CreateButton["default"], {
