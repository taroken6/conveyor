...
var DefaultIndexTitle = function DefaultIndexTitle(_ref) {
  ...
  var tableFilters = R.prop('tableOptions', actions);
...
var Index = function Index(_ref3) {
  ...
  var _tableFilters = _objectSpread({}, tableFilters),
      currentFilters = _tableFilters.currentFilters,
      filterOrder = _tableFilters.filterOrder,
      filtersAreActive = _tableFilters.filtersAreActive;
