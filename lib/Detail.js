...
var DefaultDetailAttribute = function DefaultDetailAttribute(_ref3) {
  ...
  if ((0, _Edit.isFieldEditing)(editData, modelName, node.id, fieldName) !== false) {
    ...
    }, (0, _Utils.skipOverride)(labelOverride) ? '' : _react["default"].createElement(DetailLabel, {
      schema: schema,
      modelName: modelName,
      fieldName: fieldName,
      data: node
    ...
    return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("dt", {
      ...
      className: "col-sm-9"
    }, (0, _Utils.skipOverride)(valueOverride) ? '' : _react["default"].createElement(DetailValue, {
      schema: schema,
      modelName: modelName,
      fieldName: fieldName,
      node: node,
...
var DefaultDetailTable = function DefaultDetailTable(_ref8) {
  var schema = _ref8.schema,
      ...
      props = _objectWithoutProperties(_ref8, ["schema", "modelName", "id", "fieldName", "node", "path", "editData", "selectOptions", "tooltipData"]);
  ...
  if (type.includes('OneToMany')) {
    ...
    return _react["default"].createElement(_react["default"].Fragment, {
    ...
    }, (0, _Utils.skipOverride)(labelOverride) ? '' : _react["default"].createElement(DetailLabel, _objectSpread({
      schema: schema,
      modelName: modelName,
      fieldName: fieldName,
      targetInverseFieldName: targetInverseFieldName,
      ...
      fieldName: fieldName,
      data: node
    })), (0, _Utils.skipOverride)(valueOverride) ? '' : _react["default"].createElement(DetailValue, _extends({
      ...
      data: data,
      onDelete: onDelete,
      onEditSubmit: function onEditSubmit(_ref9) {
    ...
    return _react["default"].createElement(_react["default"].Fragment, {
      key: "Fragment-".concat(id, "-").concat(targetModelName, "-").concat(fieldName)
    }, (0, _Utils.skipOverride)(_labelOverride) ? '' : _react["default"].createElement(_DetailLabel, _objectSpread({
      schema: schema,
      modelName: modelName,
      id: id,
      fieldName: fieldName,
      ...
      path: path,
      targetModelName: targetModelName
    }, props)), (0, _Utils.skipOverride)(valueOverride) ? '' : _react["default"].createElement(DetailValue, _extends({
      key: "Table-".concat(id, "-").concat(targetModelName, "-").concat(fieldName)
    }, _objectSpread({
      schema: schema,
      parentId: id,
...
var partitionDetailFields = function partitionDetailFields(_ref12) {
  var schema = _ref12.schema,
      modelName = _ref12.modelName,
      node = _ref12.node,
      _ref12$include = _ref12.include,
      include = _ref12$include === void 0 ? null : _ref12$include;
...
var DefaultDetailPageTitle = function DefaultDetailPageTitle(_ref13) {
  var schema = _ref13.schema,
      modelName = _ref13.modelName,
      node = _ref13.node,
      modalData = _ref13.modalData,
      props = _objectWithoutProperties(_ref13, ["schema", "modelName", "node", "modalData"]);
...
var DetailFields = function DetailFields(_ref14) {
  var schema = _ref14.schema,
      modelName = _ref14.modelName,
      id = _ref14.id,
      node = _ref14.node,
      tableFields = _ref14.tableFields,
      descriptionList = _ref14.descriptionList,
      editData = _ref14.editData,
      tooltipData = _ref14.tooltipData,
      selectOptions = _ref14.selectOptions,
      path = _ref14.path,
      props = _objectWithoutProperties(_ref14, ["schema", "modelName", "id", "node", "tableFields", "descriptionList", "editData", "tooltipData", "selectOptions", "path"]);
...
var Wrapper = function Wrapper(_ref15) {
...
var Detail = function Detail(_ref16) {
  var schema = _ref16.schema,
      ...
      Title = _ref16$Title === void 0 ? DefaultDetailPageTitle : _ref16$Title,
      props = _objectWithoutProperties(_ref16, ["schema", "modelName", "id", "node", "modalData", "editData", "path", "match", "tooltipData", "Title"]);
