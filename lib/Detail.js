...
var CollapseTableButton = function CollapseTableButton(_ref2) {
  ...
  var CollapseTableIcon = collapse ? _fa.FaAngleDown : _fa.FaAngleDown;
...
var DefaultDetailO2MTableTitle = function DefaultDetailO2MTableTitle(_ref7) {
  ...
  var _getFieldOrderAlterDe = (0, _FiledOrderAlter.getFieldOrderAlterDetailProps)({
    schema: schema,
    modelName: modelName,
    targetModelName: targetModelName,
    fieldName: fieldName,
    ...
    customProps: customProps
      ...
      fieldOrderChange = _getFieldOrderAlterDe.fieldOrderChange,
      fieldOrderToggle = _getFieldOrderAlterDe.fieldOrderToggle,
      fieldOrderAltValues = _getFieldOrderAlterDe.fieldOrderAltValues,
      open = _getFieldOrderAlterDe.open,
      options = _getFieldOrderAlterDe.options,
      hasValues = _getFieldOrderAlterDe.hasValues;
  ...
  return _react["default"].createElement(DefaultDetailTableTitleWrapper, null, collapsable && _react["default"].createElement(CollapseTableButton, {
    ...
    modelName: modelName,
    fieldName: fieldName,
    className: "".concat(creatable ? undefined : 'padding-left')
...
var DefaultDetailM2MTableTitle = function DefaultDetailM2MTableTitle(_ref8) {
  ...
  var _getFieldOrderAlterDe2 = (0, _FiledOrderAlter.getFieldOrderAlterDetailProps)({
    schema: schema,
    modelName: modelName,
    targetModelName: targetModelName,
    fieldName: fieldName,
    ...
    customProps: customProps
      ...
      fieldOrderChange = _getFieldOrderAlterDe2.fieldOrderChange,
      fieldOrderToggle = _getFieldOrderAlterDe2.fieldOrderToggle,
      fieldOrderAltValues = _getFieldOrderAlterDe2.fieldOrderAltValues,
      open = _getFieldOrderAlterDe2.open,
      options = _getFieldOrderAlterDe2.options,
      hasValues = _getFieldOrderAlterDe2.hasValues;
  ...
  return _react["default"].createElement("div", {
    ...
    modelName: modelName,
    fieldName: fieldName,
    className: "".concat(editable ? undefined : 'padding-left')
  })), hasValues && open && _react["default"].createElement(_FiledOrderAlter.FieldOrderInput, {
    options: options,
    fieldOrderAltValues: fieldOrderAltValues,
    fieldOrderChange: fieldOrderChange,
