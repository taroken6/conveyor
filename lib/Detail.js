...
exports["default"] = exports.DetailFields = exports.partitionDetailFields = exports.DefaultDetailTable = exports.DefaultDetailO2MTableTitle = exports.DefaultDetailTableTitleWrapper = exports.DetailCreateButton = exports.DefaultDetailAttribute = exports.DefaultDetailLabel = exports.HideTableButton = void 0;
...
var HideTableButton = function HideTableButton(_ref2) {
  var modelName = _ref2.modelName,
      fieldName = _ref2.fieldName,
      id = _ref2.id,
      hideTable = _ref2.hideTable,
      hideTableChange = _ref2.hideTableChange;
  var image = hideTable ? 'angle-right' : 'angle-down';
  return _react["default"].createElement(_reactSvg["default"], {
    src: "/static/img/".concat(image, ".svg"),
    className: "hide-icon-".concat(hideTable ? 'angle-right' : 'angle-down'),
...
exports.HideTableButton = HideTableButton;
...
var DefaultDetailO2MTableTitle = function DefaultDetailO2MTableTitle(_ref7) {
  var schema = _ref7.schema,
      ...
      node = _ref7.node,
      user = _ref7.user,
      hideable = _ref7.hideable,
      hideTable = _ref7.hideTable,
  ...
  return _react["default"].createElement(DefaultDetailTableTitleWrapper, null, hideable && _react["default"].createElement(HideTableButton, {
    modelName: modelName,
    fieldName: fieldName,
    id: id,
    hideTable: hideTable,
...
var DefaultDetailM2MTableTitle = function DefaultDetailM2MTableTitle(_ref8) {
  var schema = _ref8.schema,
      ...
      user = _ref8.user,
      hideable = _ref8.hideable,
      hideTable = _ref8.hideTable,
  ...
  return _react["default"].createElement("div", {
    ...
    className: "d-inline"
  }, hideable && _react["default"].createElement(HideTableButton, {
    modelName: modelName,
    fieldName: fieldName,
    id: id,
    hideTable: hideTable,
...
var DefaultDetailTable = function DefaultDetailTable(_ref10) {
  ...
  var hideTable = R.path(['hideTable', modelName, id, fieldName], tableView);
  var hideTableChange = R.path(['tableOptions', 'hideTableChange'], actions);
  var hideable = (0, _schemaGetters.getHideable)(schema, modelName, fieldName); // console.log('fieldName', fieldName)
  ...
  if (type.includes('OneToMany')) {
    ...
    return _react["default"].createElement(_react["default"].Fragment, {
      ...
      hideTableChange: hideTableChange,
      customProps: customProps
    }), (0, _Utils.skipOverride)(ValueOverride) ? null : R.isNil(data) || R.isEmpty(data) ? _react["default"].createElement("div", {
      className: "mb-3"
    }, "N/A") : _react["default"].createElement(DetailValue, _extends({
