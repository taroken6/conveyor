...
var DefaultDetailM2MFieldLabel = function DefaultDetailM2MFieldLabel(_ref8) {
  ...
  var creatable = (0, _Utils.isCreatable)({
    ...
    modelName: targetModelName,
    user: user
  }); // todo: custom && pass 'node' as 'parentNode'? look at props

  var required = R.prop('required', (0, _schemaGetters.getField)(schema, modelName, fieldName)); // todo: getFieldLabel custom?
...
var Detail = function Detail(_ref17) {
  var schema = _ref17.schema,
      ...
      user = _ref17.user,
      selectOptions = _ref17.selectOptions,
      customProps = _ref17.customProps;
  ...
  return _react["default"].createElement(Wrapper, null, _react["default"].createElement(Title, {
    ...
    modalData: modalData,
    user: user
  }), _react["default"].createElement(DetailFields, {
    schema: schema,
    modelName: modelName,
    id: id,
    node: node,
