...
var getModelLabel = exports.getModelLabel = function getModelLabel(_ref2) {
  ...
  if (R.type(displayName) === 'Function') {
    return displayName({ schema: schema, modelName: modelName, data: data, ...props });
  }
  return displayName;
};
...
var DefaultDetailAttribute = exports.DefaultDetailAttribute = function DefaultDetailAttribute(_ref5) {
  ...
  var editable = (0, _Utils.isFieldEditable)({ schema: schema, modelName: modelName, fieldName: fieldName, node: node, id: id, ...props });
...
var DefaultDetailM2MTableTitle = function DefaultDetailM2MTableTitle(_ref9) {
  ...
  var editable = (0, _Utils.isFieldEditable)({ schema: schema, modelName: modelName, fieldName: fieldName, node: node, ...props });
  return _react2.default.createElement(
    'div',
    { style: { marginBottom: '10px' } },
    _react2.default.createElement(
...
var DefaultDetailPageTitle = function DefaultDetailPageTitle(_ref15) {
  ...
  return _react2.default.createElement(
    ...
    (0, _Utils.isDeletable)({ schema: schema, modelName: modelName, node: node, ...props }) && _react2.default.createElement(
      'div',
...
var Detail = function Detail(_ref18) {
  ...
  if (tabs && tabs.length > 0) {
    return _react2.default.createElement(
      Wrapper,
      null,
      _react2.default.createElement(Title, { schema: schema, modelName: modelName, node: node, modalData: modalData, ...props }),
