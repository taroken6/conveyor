...
exports.InputSelect = exports.InputCheckbox = exports.InputSwitch = exports.InputFile = exports.InputRadio = exports.InputTextArea = exports.InputCurrency = exports.InputInt = exports.InputPassword = exports.InputString = exports.InputDate = exports.dateValueToMoment = exports.FormGroup = undefined;
...
var dateValueToMoment = exports.dateValueToMoment = function dateValueToMoment(_ref4) {
  var value = _ref4.value,
      format = _ref4.format;

  if (value === null || value === undefined || value === '') return null;
  if (typeof value === 'string') return (0, _moment2.default)(value, format);
...
var InputDate = exports.InputDate = function InputDate(_ref5) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_reactDatepicker2.default, _extends({
        ...
        selected: dateValueToMoment({ value: value, format: dateFormat }),
        className: '' + className + (error ? ' is-invalid' : ''),
        onChange: function onChange(evt) {
          if (evt === undefined || evt === null) {
            return _onChange(null);
          }
          return _onChange((0, _moment2.default)(evt).format('YYYY-MM-DD'));
        },
...
var InputString = exports.InputString = function InputString(_ref6) {
  var type = _ref6.type,
...
var InputPassword = exports.InputPassword = function InputPassword(_ref7) {
  var _onChange3 = _ref7.onChange,
      id = _ref7.id,
...
var InputInt = exports.InputInt = function InputInt(_ref8) {
  var _onChange4 = _ref8.onChange,
      id = _ref8.id,
...
var InputCurrency = exports.InputCurrency = function InputCurrency(_ref9) {
  var _onChange5 = _ref9.onChange,
      id = _ref9.id,
...
var InputTextArea = exports.InputTextArea = function InputTextArea(_ref10) {
  var _onChange6 = _ref10.onChange,
      id = _ref10.id,
...
var InputRadio = exports.InputRadio = function InputRadio(_ref11) {
  var _onChange7 = _ref11.onChange,
      id = _ref11.id,
...
var InputFile = exports.InputFile = function InputFile(_ref12) {
...
var InputSwitch = exports.InputSwitch = function InputSwitch(_ref13) {
  var _onChange8 = _ref13.onChange,
      value = _ref13.value,
      inline = _ref13.inline,
      id = _ref13.id,
      ...
      customLabel = _ref13.customLabel;
  return _react2.default.createElement(
    FormGroup,
    { labelStr: labelStr, htmlFor: id, error: error, required: required,
      customError: R.defaultTo(CustomErrorComponent, customError),
...
var InputCheckbox = exports.InputCheckbox = function InputCheckbox(_ref14) {
  var _onChange9 = _ref14.onChange,
      value = _ref14.value,
      id = _ref14.id,
      className = _ref14.className,
      labelStr = _ref14.labelStr,
      error = _ref14.error,
...
var InputSelect = exports.InputSelect = function InputSelect(_ref15) {
  var labelStr = _ref15.labelStr,
      id = _ref15.id,
      error = _ref15.error,
      className = _ref15.className,
      isClearable = _ref15.isClearable,
      isMulti = _ref15.isMulti,
      value = _ref15.value,
      options = _ref15.options,
      onChange = _ref15.onChange,
      noOptionsMessage = _ref15.noOptionsMessage,
