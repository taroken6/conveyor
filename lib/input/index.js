...
var includeProps = ['type', 'id', 'value', 'dateFormat', 'labelStr', 'onChange', 'inline', 'options', 'className', 'isClearable', 'isMulti', 'noOptionsMessage', 'onMenuOpen', 'error', 'required', 'customProps', 'customError', 'customLabel', 'autoFocus', 'onKeyDown'];
