...
var getFooterFields = function getFooterFields(_ref8) {
  var schema = _ref8.schema,
      modelName = _ref8.modelName,
      fieldName = _ref8.fieldName,
      customProps = _ref8.customProps;
  var footerFieldOrder = R.prop('fieldOrder', getModel(schema, modelName));
  var defaultOrder = getShownFooters({
    schema: schema,
    modelName: modelName,
    type: fieldName.type,
    fieldName: fieldName,
...
exports.getFooterFields = getFooterFields;

var getShownFooters = function getShownFooters(_ref9) {
  ...
  var fields = R.prop('fields', getModel(schema, modelName));
  return R.filter(function (fieldName) {
    var show;
...
exports.getShownFooters = getShownFooters;

var getFooterLabel = function getFooterLabel(_ref10) {
...
exports.getFooterLabel = getFooterLabel;
...
var getOptionsOverride = function getOptionsOverride(_ref11) {
  var schema = _ref11.schema,
      modelName = _ref11.modelName,
      fieldName = _ref11.fieldName,
      options = _ref11.options,
      formStack = _ref11.formStack,
      value = _ref11.value,
      modelStore = _ref11.modelStore;
