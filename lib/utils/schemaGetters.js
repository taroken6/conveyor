...
var getShownFooters = function getShownFooters(_ref9) {
  ...
  var fieldOrder = R.prop('fieldOrder', getModel(schema, modelName));
  return R.filter(function (fieldName) {
    var show = R.propOr(false, type, getField(schema, modelName, fieldName));
...
var getOptionsOverride = function getOptionsOverride(_ref10) {
