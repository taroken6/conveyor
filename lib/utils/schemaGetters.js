...
var getFieldCondition = function getFieldCondition(schema, modelName, fieldName) {
  return R.prop('condition', getField(schema, modelName, fieldName));
};

exports.getFieldCondition = getFieldCondition;