...
var FieldToMany = exports.FieldToMany = function FieldToMany(_ref9) {
  ...
  var relListWithLink = function relListWithLink(field, idx, obj) {
    return _react2.default.createElement(
      ...
      { key: 'fragment-' + field.node.id },
      _react2.default.createElement(FieldToOne, _extends({
        key: 'field-m2o-' + field.node.id
      }, { schema: schema, modelName: modelName, fieldName: fieldName, parentModelName: parentModelName, tooltipData: tooltipData, node: field.node })),
  ...
  return _react2.default.createElement(
    'span',
    null,
    multiRelField && multiRelField.edges.length > 0 ? multiRelField.edges.map(relListWithLink) : 'N/A'
  );
};
