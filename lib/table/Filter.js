...
exports.FilterComp = exports.FilterModalButton = exports.FilterModal = exports.isTableFilterable = exports.isFilterable = void 0;
...
var isFilterable = function isFilterable(_ref) {
  ...
  var fieldFilterable = R.pathOr(true, [modelName, fieldName, 'filterable'], schema);
  ...
  return !(R.isNil(inputType) || inputType === _consts.inputTypes.CREATABLE_STRING_SELECT_TYPE || inputType === _consts.inputTypes.RELATIONSHIP_MULTIPLE || inputType === _consts.inputTypes.PHONE_TYPE || inputType === _consts.inputTypes.ID_TYPE);
};
