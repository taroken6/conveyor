...
var isColFilterable = function isColFilterable(_ref2) {
  var schema = _ref2.schema,
      ...
      tableFilters = _ref2.tableFilters,
      filterable = _ref2.filterable;
  return !!tableFilters && filterable && isFilterable({
    schema: schema,
    modelName: modelName,
    fieldName: fieldName
  });
...
var isTableFilterable = function isTableFilterable(_ref3) {
  var schema = _ref3.schema,
      ...
      tableFilters = _ref3.tableFilters;
...
var FilterModal = function FilterModal(_ref8) {
  var schema = _ref8.schema,
      ...
      data = _ref8.data,
      currentFilters = _ref8.currentFilters,
...
var FilterDropdown = function FilterDropdown(_ref10) {
...
var FilterOptions = function FilterOptions(_ref11) {
...
var FilterPopover = function FilterPopover(_ref12) {
...
var FilterComp = function FilterComp(_ref13) {
  var fieldName = _ref13.fieldName,
      ...
      filterInput = _ref13.filterInput,
