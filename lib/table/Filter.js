...
var isFilterable = function isFilterable(_ref) {
  ...
  inputType === _consts.inputTypes.RELATIONSHIP_MULTIPLE || // (inputType === inputTypes.DATE_TYPE) ||
  inputType === _consts.inputTypes.PHONE_TYPE || // (inputType === inputTypes.BOOLEAN_TYPE) ||
  inputType === _consts.inputTypes.ID_TYPE || // todo: add back currency once filter permissions added
...
var isDropdownField = function isDropdownField(_ref11) {
  var schema = _ref11.schema,
      modelName = _ref11.modelName,
      fieldName = _ref11.fieldName;
  console.log('type', (0, _InputType.getInputType)({
    schema: schema,
    modelName: modelName,
    fieldName: fieldName
  }));

  switch ((0, _InputType.getInputType)({
    schema: schema,
    modelName: modelName,
    fieldName: fieldName
  })) {
...
var FilterComp = function FilterComp(_ref12) {
  ...
  var inputValue = isDropdownField({
    schema: schema,
    modelName: modelName,
    fieldName: fieldName
  }) ? value : {
