...
var TFoot = function TFoot(_ref) {
  ...
  return _react["default"].createElement("tfoot", null, _react["default"].createElement("tr", null, fieldOrder.map(function (fieldName, idx) {
    ...
    var showFooter = (0, _schemaGetters.getShownFooters)({
      schema: schema,
      modelName: modelName,
      type: 'summable',
      data: data,
    ...
    var showSummation = (0, _Utils.isSummable)({
      schema: schema,
      modelName: modelName,
      fieldName: fieldName,
      user: user
...
var Footer = function Footer(_ref2) {
  var schema = _ref2.schema,
      ...
      title = _ref2.title,
      data = _ref2.data,
      showFooter = _ref2.showFooter,
      showSummation = _ref2.showSummation,
  ...
  }, title), showSummation && _react["default"].createElement(_Summation.Summation, {
    schema: schema,
    modelName: modelName,
    fieldName: fieldName,
    data: data
