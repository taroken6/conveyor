...
var TFoot = function TFoot(_ref) {
  ...
  var showFooter = R.any(function (fieldName) {
    var summaryPath = fromIndex ? [modelName, fieldName] : [parentModelName, parentFieldName, fieldName];
...
var Footer = function Footer(_ref2) {
  ...
  return _react["default"].createElement("div", {
    ...
    className: "sum"
  }, fromIndex ? showFooterInfo && _react["default"].createElement(_Summation.Summation, {
    schema: schema,
    modelName: modelName,
    fieldName: fieldName,
    title: title,
