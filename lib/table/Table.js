...
var _FiledOrderAlter = require("./FiledOrderAlter");
...
var TableButtonGroup = function TableButtonGroup(_ref5) {
  ...
  var parentFieldType = (0, _getType.getType)({
    schema: schema,
  ...
  R.isNil(detailField) && _react["default"].createElement(DetailViewButton, {
    ...
    name: (0, _getDisplayValue["default"])({
      schema: schema,
      modelName: modelName,
      parentModelName: parentModelName,
      node: node,
...
var calcDetailField = function calcDetailField(_ref9) {
  ...
  var schemaDefinedLinkField = R.prop('tableLinkField', model); // If the schema does not define a displayField then check if there is a name field
...
var Table = function Table(_ref10) {
  ...
  fieldOrder = (0, _FiledOrderAlter.getFieldOrderAlternate)({
    tableView: tableView,
    parentModelName: parentModelName,
    parentFieldName: parentFieldName,
    modelName: modelName,
