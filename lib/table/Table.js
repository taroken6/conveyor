...
var TableRowWithEdit = exports.TableRowWithEdit = function TableRowWithEdit(_ref5) {
  ...
  if ((0, _Edit.isEditing)(editData, modelName, node.id) && (0, _Utils.isFieldEditable)({ schema: schema, modelName: modelName, fieldName: fieldName, node: node, user: user })) {
...
var TBody = exports.TBody = function TBody(_ref7) {
  ...
  return _react2.default.createElement(
    ...
    data.map(function (node, idx) {
      var editable = (0, _Utils.isRowEditable)({ schema: schema, modelName: modelName, node: node, user: user, ...props });
...
var Table = exports.Table = function Table(_ref9) {
  ...
  var deletable = (0, _Utils.isTableDeletable)({ schema: schema, modelName: modelName, data: data, ...props });
