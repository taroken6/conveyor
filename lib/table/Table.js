...
var HideTableButton = function HideTableButton(_ref9) {
  var modelName = _ref9.modelName,
      fieldName = _ref9.fieldName,
      id = _ref9.id,
      hideTable = _ref9.hideTable,
      hideTableChange = _ref9.hideTableChange;
  ...
  }, hideTable ? 'Show' : 'Hide', _react["default"].createElement(_reactSvg["default"], {
...
var Table = function Table(_ref10) {
  ...
  var hideTable = R.path(['hideTable', parentModelName, parentId, parentFieldName], tableView);
  var actions = (0, _schemaGetters.getActions)(schema, modelName);
  ...
  return _react["default"].createElement(_react["default"].Fragment, null, !fromIndex && _react["default"].createElement(HideTableButton, {
    modelName: parentModelName,
    fieldName: parentFieldName,
    id: parentId,
    hideTable: hideTable,
    hideTableChange: hideTableChange
  }), (fromIndex || !hideTable) && _react["default"].createElement("table", {
