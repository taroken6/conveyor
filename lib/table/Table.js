...
var TableButtonGroup = function TableButtonGroup(_ref5) {
  ...
  R.isNil(detailField) && _react["default"].createElement(DetailViewButton, {
    ...
    id: node.id,
    node: node
  }), fromDetail && m2m && editable && _react["default"].createElement(RemoveButton, {
    modalId: modalId,
    ...
    modelName: modelName,
    id: id
  })), fromDetail && m2m && _react["default"].createElement(_DeleteDetail.RemoveDetail, {
    schema: schema,
    id: id,
    modalId: modalId,
    modelName: modelName,
