...
exports.Table = exports.calcDetailField = exports.TBody = exports.TableButtonCell = exports.TableRowWithEdit = exports.TableButtonGroup = exports.showButtonColumn = exports.DeleteButton = exports.DetailViewButton = void 0;
...
var TBody = function TBody(_ref7) {
  ...
  return _react["default"].createElement("tbody", null, data.map(function (node, idx) {
    var editable = (0, _Utils.isRowEditable)(_objectSpread({
      ...
      node: node,
      user: user
    }, props)); // do not pass '...props' into below component because contains 'node' from parent object: will conflict with new 'node' from data.map()
...
var Table = function Table(_ref9) {
  var schema = _ref9.schema,
      ...
      props = _objectWithoutProperties(_ref9, ["schema", "modelName", "node", "data", "fieldOrder", "onDelete", "onEditSubmit", "modalData", "editData", "selectOptions", "parentId", "parentModelName", "parentFieldName", "tooltipData", "tableOptions", "Head", "Body"]);
  ...
  return _react["default"].createElement("table", {
  ...
  }, _react["default"].createElement(Head, _objectSpread({
    schema: schema,
    modelName: modelName,
    fieldOrder: fieldOrder,
    data: data,
    ...
    filterable: filterable,
    tableOptions: tableOptions
  }, props)), _react["default"].createElement(Body, _objectSpread({
    schema: schema,
    modelName: modelName,
    data: data,
    onDelete: onDelete,
