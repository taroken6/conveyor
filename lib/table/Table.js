...
var TableRowWithEdit = function TableRowWithEdit(_ref5) {
  var modelName = _ref5.modelName,
      ...
      props = _objectWithoutProperties(_ref5, ["modelName", "fieldName", "parentModelName", "node", "schema", "detailField", "editData", "tooltipData", "selectOptions", "user", "parentNode"]);

  if ((0, _Edit.isEditing)(editData, modelName, node.id) && (0, _Utils.isFieldEditable)(_objectSpread({
    schema: schema,
    modelName: modelName,
    fieldName: fieldName,
    node: node,
  ...
  if (Override) {
    return _react["default"].createElement(Override, _objectSpread({
      schema: schema,
      modelName: modelName,
      fieldName: fieldName,
      parentModelName: parentModelName,
  ...
  if (detailField === fieldName) {
    var displayString = (0, _getDisplayValue["default"])(_objectSpread({
      schema: schema,
      modelName: modelName,
      parentModelName: parentModelName,
      node: node
...
var TBody = function TBody(_ref7) {
  var schema = _ref7.schema,
      ...
      props = _objectWithoutProperties(_ref7, ["schema", "modelName", "data", "fieldOrder", "onDelete", "onEditSubmit", "parentId", "parentModelName", "parentFieldName", "detailField", "tooltipData", "modalData", "editData", "tableEditable", "deletable", "selectOptions", "user", "parentNode"]);
  ...
  return _react["default"].createElement("tbody", null, data.map(function (node, idx) {
    var editable = (0, _Utils.isRowEditable)(_objectSpread({
      schema: schema,
      modelName: modelName,
      node: node,
      user: user
...
var Table = function Table(_ref9) {
  var schema = _ref9.schema,
      ...
      user = _ref9.user,
      props = _objectWithoutProperties(_ref9, ["schema", "modelName", "node", "data", "fieldOrder", "onDelete", "onEditSubmit", "modalData", "editData", "selectOptions", "parentId", "parentModelName", "parentFieldName", "tooltipData", "tableOptions", "Head", "Body", "user"]);
  ...
  var deletable = (0, _Utils.isTableDeletable)(_objectSpread({
    schema: schema,
    modelName: modelName,
    data: data,
    parentNode: parentNode,
  ...
  var editable = (0, _Utils.isTableEditable)(_objectSpread({
    schema: schema,
    modelName: modelName,
    data: data,
    parentNode: parentNode,
  ...
  return _react["default"].createElement("table", {
    ...
    filterable: filterable,
    tableOptions: tableOptions
  }), _react["default"].createElement(Body, _objectSpread({
    schema: schema,
    modelName: modelName,
    data: data,
    onDelete: onDelete,
