...
var TableButtonGroup = function TableButtonGroup(_ref5) {
  ...
  console.log('actions', actions); // const onRemove = () => {console.log('REMOVED')} // temporary placeholder
  ...
  R.isNil(detailField) && _react["default"].createElement(DetailViewButton, {
    ...
    id: node.id,
    node: node
  }), !fromIndex && m2m && editable && _react["default"].createElement(RemoveButton, {
    modalId: modalId,
    ...
    modelName: modelName,
    id: id
  })), !fromIndex && m2m && _react["default"].createElement(_DeleteDetail.RemoveDetail, {
    schema: schema,
    id: id,
    modalId: modalId,
    modelName: modelName,
