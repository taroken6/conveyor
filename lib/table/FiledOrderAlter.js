...
var getFieldOrderAlternate = function getFieldOrderAlternate(_ref) {
  ...
  var fieldOrderAltValues = fieldName ? R.pathOr([], [modelName, 'fields', fieldName, 'fieldOrderAlt', 'values'], tableView) : R.pathOr([], [modelName, 'fieldOrderAlt', 'values'], tableView); // get fieldNames from form object
...
var FieldOrderAlterButton = function FieldOrderAlterButton(_ref2) {
  ...
  })), hasValues && open && _react["default"].createElement("div", null, _react["default"].createElement("div", {
...
var FieldOrderAlterDetail = function FieldOrderAlterDetail(_ref3) {
  ...
  var open = R.pathOr(true, [modelName, 'fields', fieldName, 'fieldOrderAlt', 'open'], tableView);
...
var FieldOrderAlter = function FieldOrderAlter(_ref5) {
  var schema = _ref5.schema,
      ...
      fieldOrderToggle = _ref5.fieldOrderToggle,
      node = _ref5.node,
      customProps = _ref5.customProps;
  // if has values, display
  var hasValues = fieldOrderAltValues && !R.isEmpty(fieldOrderAltValues); // get dropdown options
