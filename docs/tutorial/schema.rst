...
*All schema information is primarily generated by the back end. Any frontend schema changes override backend settings.
...

  {
    <modelName>: {
      ...
      tableLinkField: "" #name of the field/column in a table that have a hyperlink to the detail page, a value of null means no link to the model should be displayed on a table
